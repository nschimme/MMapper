...
void CommsPage::connectSignals()
{
    ...
    // Font styling
    connect(m_yellAllCapsCheck, &QCheckBox::stateChanged, this, &CommsPage::slot_onYellAllCapsChanged);
    connect(m_whisperItalicCheck, &QCheckBox::stateChanged, this, &CommsPage::slot_onWhisperItalicChanged);
    connect(m_emoteItalicCheck, &QCheckBox::stateChanged, this, &CommsPage::slot_onEmoteItalicChanged);

    // Display options
    connect(m_showTimestampsCheck, &QCheckBox::stateChanged, this, &CommsPage::slot_onShowTimestampsChanged);
}
...
void CommsPage::slot_onYellAllCapsChanged(int state)
{
    setConfig().comms.yellAllCaps.set(static_cast<Qt::CheckState>(state) == Qt::Checked);
    emit sig_commsSettingsChanged();
}

void CommsPage::slot_onWhisperItalicChanged(int state)
{
    setConfig().comms.whisperItalic.set(static_cast<Qt::CheckState>(state) == Qt::Checked);
    emit sig_commsSettingsChanged();
}

void CommsPage::slot_onEmoteItalicChanged(int state)
{
    setConfig().comms.emoteItalic.set(static_cast<Qt::CheckState>(state) == Qt::Checked);
    emit sig_commsSettingsChanged();
}

void CommsPage::slot_onShowTimestampsChanged(int state)
{
    setConfig().comms.showTimestamps.set(static_cast<Qt::CheckState>(state) == Qt::Checked);
    emit sig_commsSettingsChanged();
}