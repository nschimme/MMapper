...
struct NODISCARD ConnectionDrawerColorBuffer final
{
    ...
    NODISCARD bool empty() const { return triVerts.empty() && lineVerts.empty(); }
};
...
private:
    ...
    public:
        ...
        void generateLine(const glm::vec3 &p1, const glm::vec3 &p2, const Color &color);
    };
