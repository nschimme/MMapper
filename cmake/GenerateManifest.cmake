...
# Scans an assets directory and generates a JSON manifest mapping logical keys to relative URLs.
#
# Usage:
...
if(NOT ASSETS_DIR)
    message(FATAL_ERROR "ASSETS_DIR not specified for GenerateManifest.cmake")
endif()
if(NOT OUTPUT_FILE)
