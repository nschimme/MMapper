...
void TestWorldComparisonStats::testNoChange()
{
    ...
    Change change = room_change_types::ModifyRoomFlags{roomA,
                                                       RoomNote{"New note"},
...
{
    World initial = create_initial_world();
    Change change = exit_change_types::SetExitFlags{FlagChangeEnum::Add,
                                                    roomA,
                                                    ExitDirEnum::EAST,
...
{
    World initial = create_initial_world();
    Change change = room_change_types::ModifyRoomFlags{roomC,
                                                       RoomTerrainEnum::CAVE,
                                                       FlagModifyModeEnum::ASSIGN}; // RoomC in Area2
    TestWorlds worlds = apply_change_to_world(initial, change);
    WorldComparisonStats stats = World::getComparisonStats(worlds.world_before, worlds.world_after);
