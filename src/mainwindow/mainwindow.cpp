...
#include <QCloseEvent>
// QDesktopServices is already included
#include <QFileDialog>
...
void MainWindow::createActions()
{
    ...
    actionReportIssue = new QAction(QIcon::fromTheme("tools-report-bug"), tr("Report an &Issue..."), this);
...
void MainWindow::setupMenuBar()
{
    ...
    helpMenu->addAction(actionReportIssue); // Added here
    if constexpr (!NO_UPDATER) {
