...
#undef X_INIT_MAP
        ...
        std::ignore = setColor(NamedColorEnum::WEATHER_DAWN, Color(102, 76, 51, 25));    // 0.4, 0.3, 0.2, 0.1
        std::ignore = setColor(NamedColorEnum::WEATHER_DUSK, Color(76, 51, 102, 51));   // 0.3, 0.2, 0.4, 0.2
        std::ignore = setColor(NamedColorEnum::WEATHER_NIGHT, Color(13, 13, 51, 89));   // 0.05, 0.05, 0.2, 0.35
    }
