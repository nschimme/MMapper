...
InputWidget::InputWidget(QWidget *const parent, InputWidgetOutputs &outputs, HotkeyManager &hotkeyManager)
...
void InputWidget::functionKeyPressed(int key, Qt::KeyboardModifiers modifiers)
{
    ...
    const QString command = m_hotkeyManager.getCommandQString(key, modifiers, false);
...
bool InputWidget::numpadKeyPressed(int key, Qt::KeyboardModifiers modifiers)
{
    ...
    const QString command = m_hotkeyManager.getCommandQString(key, modifiers, true);
