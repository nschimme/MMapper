...
ConstString KEY_QML_SHELL_DOCK_LOG_FLOATING = "Dock Log Floating";
ConstString KEY_QML_SHELL_DOCK_GROUP_FLOATING = "Dock Group Floating";
ConstString KEY_QML_SHELL_DOCK_ROOM_FLOATING = "Dock Room Floating";
ConstString KEY_QML_SHELL_DOCK_ADVENTURE_FLOATING = "Dock Adventure Floating";
ConstString KEY_QML_SHELL_DOCK_DESCRIPTION_FLOATING = "Dock Description Floating";
ConstString KEY_QML_SHELL_DOCK_TIMERS_FLOATING = "Dock Timers Floating";
ConstString KEY_QML_SHELL_DOCK_TASKS_FLOATING = "Dock Tasks Floating";
ConstString KEY_QML_SHELL_DOCK_CLIENT_FLOATING = "Dock Client Floating";
ConstString KEY_QML_SHELL_DOCK_LOG_FLOAT_GEOMETRY = "Dock Log Float Geometry";
ConstString KEY_QML_SHELL_DOCK_GROUP_FLOAT_GEOMETRY = "Dock Group Float Geometry";
ConstString KEY_QML_SHELL_DOCK_ROOM_FLOAT_GEOMETRY = "Dock Room Float Geometry";
ConstString KEY_QML_SHELL_DOCK_ADVENTURE_FLOAT_GEOMETRY = "Dock Adventure Float Geometry";
ConstString KEY_QML_SHELL_DOCK_DESCRIPTION_FLOAT_GEOMETRY = "Dock Description Float Geometry";
...
void Configuration::QmlShellSettings::read(const QSettings &conf)
{
    ...
    dockLogFloating = conf.value(KEY_QML_SHELL_DOCK_LOG_FLOATING, false).toBool();
    dockGroupFloating = conf.value(KEY_QML_SHELL_DOCK_GROUP_FLOATING, false).toBool();
    dockRoomFloating = conf.value(KEY_QML_SHELL_DOCK_ROOM_FLOATING, false).toBool();
    dockAdventureFloating = conf.value(KEY_QML_SHELL_DOCK_ADVENTURE_FLOATING, false).toBool();
    dockDescriptionFloating = conf.value(KEY_QML_SHELL_DOCK_DESCRIPTION_FLOATING, false).toBool();
    dockTimersFloating = conf.value(KEY_QML_SHELL_DOCK_TIMERS_FLOATING, false).toBool();
    dockTasksFloating = conf.value(KEY_QML_SHELL_DOCK_TASKS_FLOATING, false).toBool();
    dockClientFloating = conf.value(KEY_QML_SHELL_DOCK_CLIENT_FLOATING, false).toBool();
    dockLogFloatGeometry = conf.value(KEY_QML_SHELL_DOCK_LOG_FLOAT_GEOMETRY).toByteArray();
    dockGroupFloatGeometry = conf.value(KEY_QML_SHELL_DOCK_GROUP_FLOAT_GEOMETRY).toByteArray();
    dockRoomFloatGeometry = conf.value(KEY_QML_SHELL_DOCK_ROOM_FLOAT_GEOMETRY).toByteArray();
    dockAdventureFloatGeometry = conf.value(KEY_QML_SHELL_DOCK_ADVENTURE_FLOAT_GEOMETRY)
                                     .toByteArray();
    dockDescriptionFloatGeometry = conf.value(KEY_QML_SHELL_DOCK_DESCRIPTION_FLOAT_GEOMETRY)
                                       .toByteArray();
...
void Configuration::QmlShellSettings::write(QSettings &conf) const
{
    ...
    conf.setValue(KEY_QML_SHELL_DOCK_LOG_FLOATING, dockLogFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_GROUP_FLOATING, dockGroupFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_ROOM_FLOATING, dockRoomFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_ADVENTURE_FLOATING, dockAdventureFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_DESCRIPTION_FLOATING, dockDescriptionFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_TIMERS_FLOATING, dockTimersFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_TASKS_FLOATING, dockTasksFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_CLIENT_FLOATING, dockClientFloating);
    conf.setValue(KEY_QML_SHELL_DOCK_LOG_FLOAT_GEOMETRY, dockLogFloatGeometry);
    conf.setValue(KEY_QML_SHELL_DOCK_GROUP_FLOAT_GEOMETRY, dockGroupFloatGeometry);
    conf.setValue(KEY_QML_SHELL_DOCK_ROOM_FLOAT_GEOMETRY, dockRoomFloatGeometry);
    conf.setValue(KEY_QML_SHELL_DOCK_ADVENTURE_FLOAT_GEOMETRY, dockAdventureFloatGeometry);
    conf.setValue(KEY_QML_SHELL_DOCK_DESCRIPTION_FLOAT_GEOMETRY, dockDescriptionFloatGeometry);
