    ...
    while (!(xml.tokenType() == QXmlStreamReader::EndElement && xml.name() == QStringLiteral("room"))) {
        if (xml.tokenType() == QXmlStreamReader::StartElement) {
            if (xml.name() == QStringLiteral("room")) {
                ...
                room.setDescription(mmqt::makeRoomDesc(xml.readElementText().replace(QStringLiteral("|"), QStringLiteral("\n"))));
        ...
        if (xml.tokenType() == QXmlStreamReader::StartElement) {
            if (xml.name() == QStringLiteral("exit")) {
                ...
                if (attr.hasAttribute("dir") && attr.hasAttribute("to")
                    ...
                    if (to == QLatin1String("DEATH")) {
                        helper.addExitToDeathtrap(room.id, dir);
                    } else if (to == QLatin1String("UNDEFINED")) {
                    ...
                    if (doorName != nullptr && !doorName.isEmpty()) {
                        ...
                        if (doorName != QLatin1String("exit")) {
