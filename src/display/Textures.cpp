...
struct TilingPerlin
{
    ...
    TilingPerlin()
    {
        static const int permutation[] = {
            ...
            152, 2,   44,  154, 163, 70,  221, 153, 101, 155, 167, 43,  167, 172, 9,   129, 22,  39,
            ...
            107, 49,  192, 214, 31,  181, 199, 106, 157, 184, 84,  204, 176, 115, 121, 50,  45,  127,
...
static QImage generateNoiseImage(int size)
{
    ...
    for (int y = 0; y < size; ++y) {
        for (int x = 0; x < size; ++x) {
            ...
            // Green channel for Clouds: smaller scale
...
void MapCanvas::initTextures()
{
    ...
    // weather noise texture
    textures.weather_noise = MMTexture::alloc(std::vector<QImage>{generateNoiseImage(256)});
