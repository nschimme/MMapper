...
{
    m_move = move;
    // All m_expectedMove related logic definitively removed.
}

// isMostlyTheSame function removed.
// maybeUpdate function removed.
...
void MumeXmlParser::move()
{
    ...
    // const auto expectedMove = std::exchange(m_expectedMove, {}); // Removed

    const auto emitEvent = [this]() { // expectedMove removed from capture
        ...
        // if (expectedMove) { // Removed call to maybeUpdate
            // maybeUpdate(expectedMove.value(), *ev); // Removed
        // } // Removed
