...
public:
    ...
    // A double-click/double-tap zooms in this many steps (~1.9x, close to
    // the 2x map apps use) at the pointer.
    static constexpr const int DOUBLE_CLICK_ZOOM_STEPS = 4;
