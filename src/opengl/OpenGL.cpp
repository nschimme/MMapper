...
#include "./legacy/impl_es30.h"
#include "./legacy/impl_gl33.h"
...
OpenGL::OpenGL(Backend backend)
{
    switch (backend) {
    case Backend::GL33:
        m_opengl = std::make_shared<Legacy::GL33::Functions>();
        break;
    case Backend::ES30:
        m_opengl = std::make_shared<Legacy::ES30::Functions>();
        break;
    default:
        // Should never happen
        m_opengl = std::make_shared<Legacy::GL33::Functions>();
