...
void MainWindow::createActions()
{
    ...
    m_undoAction = new QAction(QIcon::fromTheme("edit-undo", QIcon(":/icons/undo.png")), // Placeholder icon
                               tr("&Undo"),
                               this);
    ...
    m_redoAction = new QAction(QIcon::fromTheme("edit-redo", QIcon(":/icons/redo.png")), // Placeholder icon
                               tr("&Redo"),
                               this);
