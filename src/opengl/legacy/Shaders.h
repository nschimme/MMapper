...
private:
    ...
    std::shared_ptr<FullScreenUColorShader> m_fullScreenUColor;
...
public:
    ...
    NODISCARD const std::shared_ptr<FullScreenUColorShader> &getFullScreenUColorShader();
